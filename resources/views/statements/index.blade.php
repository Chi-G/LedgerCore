            ...
            <table class="w-full text-left border-collapse min-w-[600px]">
                ...
                <tbody class="font-mono text-[13.5px]">
                    @forelse($entries as $entry)
                        <tr onclick="window.location='{{ route('statements.show', ['uuid' => request()->route('uuid'), 'entry' => $entry->id]) }}'" class="border-b border-ink/5 hover:bg-paper/50 transition-colors cursor-pointer">
