...
use App\Filament\Resources\CompanySettings\Pages\ViewCompanySetting;
use App\Filament\Resources\CompanySettings\Schemas\CompanySettingForm;
use App\Filament\Resources\CompanySettings\Schemas\CompanySettingInfolist;
...
class CompanySettingResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'companysetting';
    ...
    {
        return CompanySettingInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewCompanySetting::route('/{record}'),
